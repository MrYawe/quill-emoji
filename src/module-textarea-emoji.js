...
class TextAreaEmoji extends Module {
  constructor(quill, options) {
    ...
    defaultContainer.classList.add("textarea-emoji-control");
    defaultContainer.style.position = "absolute";
    defaultContainer.innerHTML = options.buttonIcon;

    this.container =
      document.getElementById(options.container) || defaultContainer;
